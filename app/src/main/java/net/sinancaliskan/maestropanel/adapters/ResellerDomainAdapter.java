...
import net.sinancaliskan.maestropanel.dialog.ResellerDomainDelete;
...
import net.sinancaliskan.maestropanel.ui.DomainsActivity;
...
public class ResellerDomainAdapter extends RecyclerView.Adapter<ResellerDomainAdapter.DomainHolder> implements SwipeableItemAdapter<ResellerDomainAdapter.DomainHolder> {
        ...
        public DomainHolder(final View itemView)//constructor for domain row
        {
            ...
            swipeable_container.setOnClickListener(new View.OnClickListener() {     //creating swipe view click listener
                ...
                public void onClick(View v) {
                    DomainsActivity main=(DomainsActivity) itemView.getContext();                   //assign MainActivity with itemview context it need type of MainActivity context
            ...
            delete.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    new ResellerDomainDelete(context,adapter,model.name);                                   //creating DomainDelete dialog with context,DomainAdapter,domain name
                }
            });
        }
        @Override
    ...
    //region adapter
    static String TAG=ResellerDomainAdapter.class.getSimpleName();
    ...
    private static ResellerDomainAdapter adapter;                                                           //define adapter for reuse
    ...
    public ResellerDomainAdapter(Context context, SwipeRefreshLayout swipeRefreshLayout, RecyclerView recyclerView, final String username){//custom constructor
    ...
    static class SwipeLeftPinningAction extends SwipeResultActionMoveToSwipedDirection {            //left pinning action
        ResellerDomainAdapter adapter;
        int position;

        public SwipeLeftPinningAction(ResellerDomainAdapter adapter, int position) {
    ...
    static class SwipeCancelAction extends SwipeResultActionDefault {                               //swipe cancel action
        ...
        public SwipeCancelAction(ResellerDomainAdapter adapter, int position) {
            this.adapter = adapter;
            this.position = position;
        }
        @Override
    ...
    //region refresh
    public void refresh() {
        service = API.getClient().create(IReseller.class);                                            //creating new Domain service api
        Call<Reply> call=service.GetDomains(key,username);                                                      //creating GetList method with api key

...
public class DomainRegister{
    ...
    public DomainRegister(final Context context, final DomainAdapter adapter) {
        ...
        builder.setPositiveButton(context.getString(R.string.register), new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {                                  //set dialog positivebutton with name and click method
                ...
                if (!chkActiveDomainUser.isChecked())
                    call=service.Create(key,domainName,planAlias,username,password,"false");        //create service call method with parameters
                else{
                    ...
                    call=service.Create(key,domainName,planAlias,username,password,"true",firstName,lastName,email,expirationDate,ip);

...
public class SubdomainDelete {
    ...
    public SubdomainDelete(final Context context,final SubdomainAdapter adapter,final String subdomain) {
        ...
        builder.setPositiveButton(context.getString(R.string.delete), new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                ...
                call=service.DeleteSubDomain(key,model.name,subdomain);

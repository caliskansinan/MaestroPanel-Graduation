...
public class ResellerDomainDelete {
    ...
    public ResellerDomainDelete(final Context context, final ResellerDomainAdapter adapter, final String domain) {
        ...
        builder.setPositiveButton(context.getString(R.string.delete), new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {                                //set dialog positivebutton with name and click method
                ...
                call=service.Delete(key,domain);                                                    //create service call method with parameters
                                                                                                    //show message for user information
                Toast.makeText(context,context.getString(R.string.domain)+context.getString(R.string.delete_operation), Toast.LENGTH_SHORT).show();
                call.enqueue(new Callback<Reply>() {                                                //adding queue to callback
                    ...
                    public void onResponse(Call<Reply> call, Response<Reply> response) {            //when callback return response
                        ...
                        adapter.removeItem(domain);                                                 //adapter remove method with domain
                    }
                    @Override

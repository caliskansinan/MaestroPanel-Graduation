...
public class DatabaseDelete {
    ...
    public DatabaseDelete(final Context context, final DatabaseAdapter adapter,final String dbType , final String database) {
        ...
        builder.setPositiveButton(context.getString(R.string.delete), new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                ...
                call=service.DeleteDatabase(key,model.name,dbType,database);
                Toast.makeText(context,context.getString(R.string.database)+context.getString(R.string.delete_operation), Toast.LENGTH_SHORT).show();
                call.enqueue(new Callback<Reply>() {
                    ...
                    public void onResponse(Call<Reply> call, Response<Reply> response) {
                        ...
                        adapter.removeItem(dbType,database);
                    }

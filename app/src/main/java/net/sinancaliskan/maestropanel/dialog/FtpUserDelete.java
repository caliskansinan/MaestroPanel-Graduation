...
public class FtpUserDelete {
    ...
    public FtpUserDelete(final Context context, final FtpAdapter adapter, final String account) {
        ...
        builder.setPositiveButton(context.getString(R.string.delete), new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                ...
                String name=account.replace("@"+model.name,"");
                call=service.DeleteFtpAccount(key,model.name,name);
                Toast.makeText(context,context.getString(R.string.ftp)+context.getString(R.string.delete_operation), Toast.LENGTH_SHORT).show();

...
public class MailBoxChangeQuota {
    ...
    public MailBoxChangeQuota(final Context context, final MailAdapter adapter, final MailAccount account) {
        ...
        final View view=layoutInflater.inflate(R.layout.dialog_mailbox_change_quota,null);
        builder.setView(view);
        Toolbar toolbar= (Toolbar) view.findViewById(R.id.dialog_toolbar);
        toolbar.setTitle(context.getString(R.string.mailbox_change_quota));

        final TextView txtQuota= (TextView) view.findViewById(R.id.txtQuota);
        txtQuota.setText(account.quota.toString());
        builder.setPositiveButton(context.getString(R.string.change), new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                ...
                call=service.ChangeMailBoxQuota(key,domainName,name,quota);
                ...
                call.enqueue(new Callback<Reply>() {
                    ...
                    public void onResponse(Call<Reply> call, Response<Reply> response) {
                        ...
                        adapter.updateItem(account,Integer.parseInt(quota));
                    }
